 ...
 * @author Andres
 */
public class AnticipoSalario extends javax.swing.JDialog {
    ...
    */
    ...
    public AnticipoSalario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTFDebCre = new javax.swing.JTextField();
        jTFIngEg = new javax.swing.JTextField();
        ...
        setTitle("ATOMSystems|Main - Registro de Anticipo de Salario");
        ...
        jLabel3.setText("REGISTRO DE ANTICIPO DE SALARIO");
        ...
        jTFCodConcepto.setEditable(false);
        jTFCodConcepto.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTFCodConcepto.setText("7");
        jTFCodConcepto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTFCodConceptoActionPerformed(evt);
            }
        });

        jTFDescConcepto.setEditable(false);
        jTFDescConcepto.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTFDescConcepto.setText("ANTICIPO DE SALARIOS");

        jTFDebCre.setEditable(false);
        jTFDebCre.setBackground(new java.awt.Color(255, 255, 204));
        jTFDebCre.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTFDebCre.setText("D");

        jTFIngEg.setEditable(false);
        jTFIngEg.setBackground(new java.awt.Color(255, 255, 204));
        jTFIngEg.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jTFIngEg.setText("E");
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTFDebCre, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jTFIngEg, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTFDebCre, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTFIngEg, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void grabarAnticipo(){
        ...
        String debCre = jTFDebCre.getText();
    ...
    private void imprimir(){
        ...
        String pCallFrom = "AnticipoSalario";
        ...
        if(jTPrinterSelected.getText().equals("Matricial")){
            ...
            imprimeAnticipoLaser();
        }
    }
    
    private void imprimeAnticipoLaser(){
        ...
        // -- Convertir en texto el monto
            ...
            if(mont.length() > 6){ // si alcanza el millon
                mont = mont.substring(0, mont.length() -1);
        ...
        try{
            ...
            LibReportes.generarReportes(sql, "adelantoSalario");
    ...
    private void jBBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscarActionPerformed
        BuscaDescBeneficioRRHH desBenf = new BuscaDescBeneficioRRHH(new JFrame(), true, "ANTICIPO");
    ...
    private void jTFCodConceptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTFCodConceptoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTFCodConceptoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AnticipoSalario dialog = new AnticipoSalario(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField jTFDebCre;
    ...
    private javax.swing.JTextField jTFIngEg;
