 ...
 * @author Andres
 */
public class TableDocsPendientesRedefinicionCuotas extends AbstractTableModel{
   ...
   public TableDocsPendientesRedefinicionCuotas (ResultSet rs){
       if(rs != null){
           try{
               rs.last();
               ...
               for (int i = 0; i < data.length; i++) {
                    ...
                    data[i][3]= rs.getInt("cod_caja");
                    data[i][4]= rs.getString("tip_comprob");
                    data[i][5]= rs.getString("fec_emision");
                    data[i][6]= rs.getString("fec_vencimiento");
